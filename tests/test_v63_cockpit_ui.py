...
def test_v63_assets_are_loaded_after_v5():
    ...
    assert '/static/v63-cockpit.css?v=6.4.0' in html
    assert '/static/v63-cockpit-ui.js?v=6.4.0' in html
...
def test_v63_chart_is_accessible_and_versioned():
    ...
    assert "const VERSION='6.4.0'" in script
    assert "VERSION = '6.4.0'" in (ROOT/'app'/'version.py').read_text(encoding='utf-8')
